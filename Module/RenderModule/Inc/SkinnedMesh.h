...
public:
	 ...
	 *
	 * @param posePalette 정점 스키닝을 수행할 때 참조할 뼈대입니다.
	 * @param invPosePalette 정점 스키닝을 수행할 때 참조할 포즈입니다.
	 * 
	 * @param posePalette 포즈 행렬 목록입니다.
	 * @param invPosePalette 역 바인드 포즈 행렬 목록입니다.
	 */
